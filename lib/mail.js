...
<body style="margin:0;padding:0;background:#0b0b10;color:#EDE7D9;font-family:'Plus Jakarta Sans',system-ui,sans-serif;">
...
export async function notifySupportInbox({ subject, text }) {
  ...
  return send({
    ...
    html: wrap(
      ...
      `<pre style="white-space:pre-wrap;font-family:system-ui,sans-serif;font-size:14px;color:rgba(237,231,217,0.85)">${safeText}</pre>`
    ),
  });
}
